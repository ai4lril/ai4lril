    ...
    return (
        <div className="w-full max-w-2xl md:max-w-4xl mx-auto py-12 md:py-16 px-4">
            ...
            <section className="mt-12" id="community-impact">
                <h2 className="text-xl font-semibold text-slate-800">Community impact</h2>
            ...
            <section className="mt-12" id="roadmap">
                ...
                <ul className="mt-3 list-disc ml-6 text-sm text-slate-700 space-y-1">
                    <li><span className="font-medium">Spontaneous Speech:</span> launch natural prompt responses for richer accents and styles.</li>
                    <li><span className="font-medium">Mobile-first recordings:</span> improved UI for low-bandwidth and small screens.</li>
                    <li><span className="font-medium">Quality signals:</span> rater agreement, confidence, and lightweight spam checks.</li>
                    <li><span className="font-medium">Research access:</span> APIs and periodic dataset releases with documentation.</li>
                </ul>
            </section>
            ...
            <section className="mt-12" id="get-involved">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                    <div className="md:col-span-2">
                        <h2 className="text-xl font-semibold text-slate-800">Get involved</h2>
            ...
            <section className="mt-12" id="contributors">
                <h2 className="text-xl font-semibold text-slate-800">Contributors</h2>
                <div className="mt-2">
            ...
            <section className="mt-12" id="faq">
                ...
                <div className="mt-4 space-y-3">
                    <details className="rounded-lg border border-slate-200 bg-white p-3">
                        ...
                        <p className="mt-2 text-sm text-slate-700">Scripted speech, (upcoming) spontaneous speech, transcriptions, and token-level annotations (POS, NER). We focus on Indian languages and scripts.</p>
                    </details>
                    <details className="rounded-lg border border-slate-200 bg-white p-3">
