    ...
    return (
        <div className="w-full max-w-2xl md:max-w-4xl py-4 px-2 md:px-4 mx-auto animate-fade-in-up">
            ...
            <div className="w-full relative">
                <div className="absolute inset-0 bg-gradient-to-b from-rose-50/30 to-pink-50/30 -z-10 rounded-xl blur-xl hidden md:block"></div>
                    ...
                    <div className="glass rounded-md md:rounded-lg p-4 shadow-md border border-gray-100 relative overflow-hidden flex flex-col">
                        ...
                        <h2 className="text-md md:text-lg font-semibold mb-3 text-gray-800 relative">
                            <span className="inline-block relative pb-1">
                                Source sentence
                                <span className="absolute -bottom-0.5 left-0 w-full h-[2px] bg-gradient-to-r from-rose-500 to-pink-500"></span>
                            </span>
                        </h2>
                            ...
                            <div className="flex gap-3 justify-center">
                                <button
                                    ...
                                    className={`group px-6 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl border-2 ${(!sentiment || loading)
                                        ...
                                        : 'bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white border-rose-400 hover:border-rose-500 hover:scale-105 active:scale-95'
